    ...
    return (
       <FooterBox>
            ...
            <div className={style.box3}>
                ...
                <Link className={style.a}>ITI-Booking.com for Business</Link>
            </div>
           ...
           <div>
               ...
               <div>
               <Link className={style.link}>ITI-Booking.com for Travel Agents</Link>
               </div>
           </div>
           <div>
               <div>
               ...
               <div>
               <Link className={style.link}>About ITI-Booking.com</Link>
               </div>
               <div>
