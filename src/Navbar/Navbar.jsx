        ...
        <div className={styles.navbarContainer}>
            <div className={styles.navbarUpperSection}>
                <div>
                        ...
                        <p style={{textDecoration:'none',color:'white' ,fontSize:'1.6rem',fontWeight:'bold'}}>Travel <span style={{color:'orange'}}>Advisor</span> </p>
            ...
            <div className={styles.navbarLowerSection}>
                <ul>
                    ...
                    <Tabs onClick={() => setTabs(3)} t={3} tab={tab}>
                        ...
                        <p className={styles.text} style={{color:'gray',cursor:'not-allowed'}}>
                            Flight + Hotel
                        </p>
                        </Link>
                    </Tabs>
